...
pub fn calc_day_length(
    ...
    let c: f64 = 360 / 365.24 * ((doy + 10) as f64) + 360 / PI * 0.0167 * a;
    let sun_declination: f64 = (c.cos() * (-23.44).sin()).asin();
...
pub fn convert_date_to_doy(
    ...
    let long_months: Vec<i32> = (1, 3, 5, 7, 8, 10, 12);
    let short_months: Vec<i32> = (4, 6, 9, 11);
