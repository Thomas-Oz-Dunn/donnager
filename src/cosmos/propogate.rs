...
*/
use crate::cosmos::gravity as grav;
...
pub struct GravConstants {
    ...
    pub k1: f64,
    pub method: Method,
    pub orbit_0: grav::Orbit,
}


pub struct Geopotential {
    pub eq_radius: f64, // Equatorial radius of the earth 
    pub ke: f64, // square root of earth's grav parameter in earth radii^3 min^-2
